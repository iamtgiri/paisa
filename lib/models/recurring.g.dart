...
void _recurringTransactionSerialize(
  ...
  writer.writeDateTime(offsets[9], object.nextDueDate);
...
RecurringTransaction _recurringTransactionDeserialize(
  ...
  object.nextDueDate = reader.readDateTime(offsets[9]);
...
extension RecurringTransactionQueryFilter on QueryBuilder<RecurringTransaction,
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryColorEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryColorGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryColorLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryColorBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconEqualTo(
    String value, {
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'categoryIcon',
        value: '',
  ...
  QueryBuilder<RecurringTransaction, RecurringTransaction,
      QAfterFilterCondition> categoryIconIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'categoryIcon',
        value: '',
...
extension RecurringTransactionQueryProperty on QueryBuilder<
  ...
  QueryBuilder<RecurringTransaction, RecurringFrequency, QQueryOperations>
      frequencyProperty() {
    return QueryBuilder.apply(this, (query) {
