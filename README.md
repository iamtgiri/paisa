...
The next release is **1.2.2** with Android build number **13**. See [CHANGELOG.md](CHANGELOG.md) for release notes and [docs/RELEASE_PROCESS.md](docs/RELEASE_PROCESS.md) for versioning rules.
